      ...
      <div className="container-fluid">
        ...
        <div className={`collapse navbar-collapse d-lg-flex justify-content-lg-end ${isNavOpen ? 'd-flex' : ''}`} id="navbarNav">
          <ul className="navbar-nav">
            ...
            <li className="nav-item">
              <Link className="nav-link text-white" to="/overview" onClick={toggleMenu}>Project Overview</Link>
            </li>
          
            <li className="nav-item">
              <Link className="nav-link text-white" to="/VideoReel" onClick={toggleMenu}> Video Reel</Link>
            </li>
